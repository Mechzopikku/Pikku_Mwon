...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Pikku Mwon public bot' : process.env.ALL_CAPTION,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '918086567984@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    RASHI: process.env.LOGO_LINK === undefined ? 'IMG-20211027-WA0091.jpg' : process.env.LOGO_LINK,
